...
export const GAMES: Game[] = [
  {
    ...
    thumbnail: 'https://images.unsplash.com/photo-1621135802920-133df287f89c?q=80&w=2070&auto=format&fit=crop',
    category: 'Arcade',
    isBuiltIn: true,
    status: 'playable',
    accentColor: 'green'
  ...
  },
  {
    ...
    thumbnail: 'https://images.unsplash.com/photo-1544636331-e26879cd4d9b?q=80&w=2070&auto=format&fit=crop',
    category: 'Shooter',
    isBuiltIn: false,
    status: 'coming-soon',
    accentColor: 'orange'
